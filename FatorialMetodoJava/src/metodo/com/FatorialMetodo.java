 ...
 * @author jeffe
 */
public class FatorialMetodo extends javax.swing.JFrame {

    /**
     * Creates new form FatorialMetodo
     */
    public FatorialMetodo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione o valor:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FatorialMetodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FatorialMetodo().setVisible(true);
            }
        });
    }
