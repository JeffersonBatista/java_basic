...
public class SuperCalculadora extends javax.swing.JFrame {
    ...
    public SuperCalculadora() {
        initComponents();
        panCalc.setVisible(false); /*Esconder Painel*/
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icone calculadora.png"))); // NOI18N

        txtNum.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtNum.setModel(new javax.swing.SpinnerNumberModel(1, -100, 100, 1));

        btnCalcula.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnCalcula.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/sinais.png"))); // NOI18N
        ...
        jLabel3.setText("Selecione um número:");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Resto da divisão (2) :");

        lblResto.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        lblResto.setForeground(new java.awt.Color(255, 51, 0));
        lblResto.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblResto.setText("0");
        lblResto.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Elevado ao cubo :");

        lblCubo.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        lblRaizQ.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        lblRaizQ.setForeground(new java.awt.Color(255, 51, 0));
        lblRaizQ.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblRaizQ.setText("0");
        lblRaizQ.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("Raíz cúbica :");

        lblRaizC.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        lblRaizC.setForeground(new java.awt.Color(255, 51, 0));
        lblRaizC.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblRaizC.setText("0");
        lblRaizC.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Absoluto :");

        lblAbs.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        lblAbs.setForeground(new java.awt.Color(255, 51, 0));
            ...
            .addGroup(panCalcLayout.createSequentialGroup()
                ...
                .addGroup(panCalcLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panCalcLayout.createSequentialGroup()
                        ...
                        .addGap(38, 38, 38)
                        .addGroup(panCalcLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblCubo, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
    ...
    private void btnCalculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculaActionPerformed
        ...
        int Resto = (Num%2);
        double Cubo = (double) Math.pow(Num,3);
        float Rq = (float) Math.sqrt(Num);
        float Rc = (float) Math.cbrt(Num);
        int Absolut = Math.abs(Num);
        ...
        lblAbs.setText(Integer.toString(Absolut));
    ...
    private int getText(JSpinner slctNum) {
