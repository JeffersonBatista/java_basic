 ...
 * @author jeffe
 */
public class SwingResolucao extends javax.swing.JFrame {

    /**
     * Creates new form SwingResolucao
     */
    public SwingResolucao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cursoemvideo/resolucao.jpg"))); // NOI18N
        ...
        lblResolucao.setText("Clique no botão para saber");

        btnClique.setBackground(new java.awt.Color(0, 0, 0));
        btnClique.setForeground(new java.awt.Color(255, 204, 0));
    ...
    private void btnCliqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCliqueActionPerformed
        ...
        lblResolucao.setText(sistema.width + " x " + sistema.height);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingResolucao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingResolucao().setVisible(true);
            }
        });
    }
